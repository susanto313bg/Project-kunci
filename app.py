...
<head>
    ...
    <style>
        /* Mengatur lebar kolom input agar pas untuk 8 karakter */
        .tid-input {
        ...
        <div class="flex-1 bg-white p-4 rounded-lg shadow-sm border border-slate-200 overflow-x-auto">
            ...
            <table class="w-full border-collapse border border-slate-300 text-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="border border-slate-300 p-2 text-center font-semibold bg-slate-50">11</td>
                        <td class="border border-slate-300 p-2"><input type="text" maxlength="8" class="tid-input border border-slate-300 rounded px-2 py-1 text-sm focus:outline-none focus:ring-1 focus:ring-emerald-600"></td>
                    </tr>
                    <tr>
                        <td class="border border-slate-300 p-2 text-center font-semibold bg-slate-50">12</td>
                        <td class="border border-slate-300 p-2"><input type="text" maxlength="8" class="tid-input border border-slate-300 rounded px-2 py-1 text-sm focus:outline-none focus:ring-1 focus:ring-emerald-600"></td>
                    </tr>
                    <tr>
                        <td class="border border-slate-300 p-2 text-center font-semibold bg-slate-50">13</td>
                        <td class="border border-slate-300 p-2"><input type="text" maxlength="8" class="tid-input border border-slate-300 rounded px-2 py-1 text-sm focus:outline-none focus:ring-1 focus:ring-emerald-600"></td>
                    </tr>
                    <tr>
                        <td class="border border-slate-300 p-2 text-center font-semibold bg-slate-50">14</td>
                        <td class="border border-slate-300 p-2"><input type="text" maxlength="8" class="tid-input border border-slate-300 rounded px-2 py-1 text-sm focus:outline-none focus:ring-1 focus:ring-emerald-600"></td>
                    </tr>
                    <tr>
                        <td class="border border-slate-300 p-2 text-center font-semibold bg-slate-50">15</td>
                        <td class="border border-slate-300 p-2"><input type="text" maxlength="8" class="tid-input border border-slate-300 rounded px-2 py-1 text-sm focus:outline-none focus:ring-1 focus:ring-emerald-600"></td>
                    </tr>
                </tbody>
            </table>
